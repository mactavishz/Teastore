 ...
 */
package tools.descartes.teastore.model.domain;
...
import tools.descartes.teastore.model.repository.AbstractPersistenceRepository;
...
public final class OrderItemRepository extends AbstractPersistenceRepository<OrderItem, PersistenceOrderItem> {
	 ...
	 */
	@Override
	public long getId(PersistenceOrderItem v) {
		return v.getId();
	}
	 ...
	 */
	@Override
	public Class<PersistenceOrderItem> getEntityClass() {
