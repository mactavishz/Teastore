...
public class AuthUserActionsRest {
    ...
    @Timed(
            ...
            name = "placeOrder",
            tags = {"method=post", "url=/useractions/placeorder"},
            absolute = true,
    ...
    @Timed(
            ...
            name = "login",
            tags = {"method=post", "url=/useractions/login"},
            absolute = true,
    ...
    @Timed(
            name = "logout",
            tags = {"method=post", "url=/useractions/logout"},
            absolute = true,
    ...
    @Timed(
            name = "isLoggedIn",
            tags = {"method=post", "url=/useractions/isloggedin"},
            absolute = true,
            description = "Time and Frequency of isLoggedIn"
    )
