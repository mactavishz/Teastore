...
import tools.descartes.teastore.model.domain.PersistenceCategory;
import tools.descartes.teastore.model.domain.PersistenceOrder;
...
public final class DataGenerator {
	...
	public void setMaintenanceModeGlobal(boolean maintenanceMode) {
		...
		// potential multicast to other persistence providers in scaled setup
		persistenceClient.setMaintenanceMode(maintenanceMode);
	}
}
